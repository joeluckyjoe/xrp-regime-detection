...
if __name__ == '__main__':
    # Backtest over a 1-year period to test robustness
    print("Fetching 1 year of historical data for long-term backtest...")
    long_term_data = fetch_historical_data(start_date_str='2024-08-20', end_date_str='2025-08-20')
    
    print("\nRunning long-term backtest with optimized parameters...")
    
    # Run the backtest using the final optimized parameters
    ...
    print("="*50)
    print(f"Period Analyzed:     {long_term_data.index[0]} to {long_term_data.index[-1]}")
    if not trades.empty:
