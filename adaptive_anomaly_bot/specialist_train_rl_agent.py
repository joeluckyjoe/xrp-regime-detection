...
import warnings
# v21: Added deque for tracking portfolio history
...
def fetch_and_prepare_data(ticker="QQQ", period="729d", interval="1h"):  
    print("--- Fetching and Preparing Multi-Scale Data (v19) ---")  
    ...
    print("--- Multi-Scale Data Preparation Complete ---"); return processed_dfs
...
class TradingEnvironment(gym.Env):  
    def __init__(self, df, surprise_scores, initial_balance=100000, trade_fee=0.001, reward_scheme='sortino'):  
        ...
        # v21: Add portfolio history for max drawdown calculation. The window is 21 steps.
    ...
    def reset(self, seed=None):  
        ...
        # v21: Reset and initialize portfolio history
    ...
    def step(self, action):  
        ...
        # v21: Add current portfolio value to history
        ...
        if len(self.returns_history) > 21:  
            ...
            # v21: Add Calmar Ratio reward scheme
