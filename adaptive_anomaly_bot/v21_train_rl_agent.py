...
class TradingEnvironment(gym.Env):
    ...
    def reset(self, seed=None):
        ...
        self.done, self.returns_history = False, []; return self._get_observation(), self._get_info()
    def step(self, action):
        ...
        self.returns_history.append((self.portfolio_value/old_portfolio_value)-1 if old_portfolio_value!=0 else 0); reward = 0
