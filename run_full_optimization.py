...
if __name__ == '__main__':
    ...
    print("\nRunning Bayesian Optimization on the full dynamic system...")
    print("This will be very slow as it refits a GARCH model for each trade.")
    ...
    print("\n" + "="*50)
    print("         FINAL BAYESIAN OPTIMIZATION COMPLETE")
    print("="*50)
